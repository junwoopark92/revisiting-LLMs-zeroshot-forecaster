...
def gpt_completion_fn(model, input_str, steps, settings, num_samples, temp):
    ...
    pred_lenth_aid_prompt = f"You will predict the next {int(steps)+1} data points.\n"
    ...
    if model in ['gpt-3.5-turbo','gpt-4','gpt-4-1106-preview']:
        ...
        response = openai.ChatCompletion.create(
            ...
            messages=[
                    ...
                    {"role": "user", "content": pred_lenth_aid_prompt + extra_input+input_str+settings.time_sep}
                ],
